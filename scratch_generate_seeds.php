<?php
/**
 * scratch_generate_seeds.php
 * Programmatically generates services-seed.json and services-seed.csv
 * with rich, high-wordcount, human-sounding content for all 15 services.
 */

// Create the directory if it doesn't exist
$seeds_dir = __DIR__ . '/jjw-core/assets/seeds';
if ( ! file_exists( $seeds_dir ) ) {
    mkdir( $seeds_dir, 0755, true );
}
...
$services = [
    [
        ...
        'keywords_context' => [
            'wedding', 'candid moments', 'bride', 'groom', 'celebration', 'ritual', 'lehenga', 'ballroom'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'pre-wedding', 'chemistry', 'couple', 'scouting', 'wardrobe', 'golden hour', 'poses', 'narrative'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'destination', 'palace', 'resort', 'travel', 'aerial', 'multi-day', 'heritage', 'global'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'cinematography', 'focal length', 'teaser', 'documentary', 'audio', 'LUTs', 'movement', 'pacing'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'maternity', 'pregnancy', 'gown', 'glow', 'sanitized', 'comfort', 'portrait', 'maternal'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'newborn', 'wraps', 'props', 'sanitized', 'safety-certified', 'asleep', 'delicate', 'heirloom'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'baby', 'milestone', 'crawling', 'smiles', 'toys', 'sanitized', 'playful', 'expression'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'cake smash', 'birthday', 'splash', 'bubble bath', 'messy', 'smash', 'theme', 'sensory'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'first birthday', 'balloons', 'number one', 'grandparents', 'legacy', 'celebration', 'growth', 'milestone'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'kids', 'children', 'candid', 'laughter', 'play-based', 'expression', 'black and white', 'curiosity'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'family', 'generations', 'legacy', 'wardrobe', 'harmony', 'grouping', 'parents', 'children'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'anniversary', 'milestone', 'couple', 'love story', 'styling', 'gold', 'timeless', 'editorial'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'couple', 'chemistry', 'romance', 'lifestyle', 'posing', 'scenic', 'intimate', 'connection'
        ]
    ],
    [
        ...
        'keywords_context' => [
            'studio', 'lighting', 'backdrop', 'softbox', 'headshot', 'profile', 'controlled', 'fashion'
        ]
    ],
    [
...
foreach ( $services as $idx => $s ) {
    ...
    // Amritsar details
    $amritsar_title = "Luxury " . $name . " in Amritsar | Fine-Art Photographer";
    $amritsar_meta = "Document your " . strtolower($name) . " in Amritsar. {brand_name} offers premium editorial photography capturing authentic moments across Punjab.";
    $amritsar_content = generate_city_text($name, 'Amritsar', '', $s['keywords_context']);
    $amritsar_cta = "<p>Ready to capture your " . strtolower($name) . " in the heritage city of Amritsar? Connect with our Ranjit Avenue studio today via WhatsApp or our booking form to check date availability and review packages.</p>";
    
    // Delhi details
    $delhi_title = "Premium " . $name . " Delhi NCR | Editorial Photography";
    $delhi_meta = "Looking for a luxury photographer for " . strtolower($name) . " in Delhi NCR? Contact {brand_name} for high-end portraits and cinematic films.";
    ...
    $faq_topics = [
        ...
        ['Q' => 'Do you travel for sessions outside primary branches?', 'A' => 'Yes, our team frequently travels across India and internationally for assignments. Travel and accommodation fees are quoted transparently during booking.'],
        ['Q' => 'How do you ensure data security during the session?', 'A' => 'Our primary cameras record to dual card slots in real-time, providing immediate data redundancy. All files are immediately copied to encrypted local drives at the end of the session.'],
        ['Q' => 'What wardrobe styles do you recommend?', 'A' => 'We recommend solid, cohesive tones (jewel colors, neutral shades, or soft pastels) and styling that avoids busy patterns. A detailed wardrobe guide is shared prior to the shoot.'],
        ['Q' => 'Can we customize our packages?', 'A' => 'Absolutely. We offer tailored collections that adapt to your schedule, coverage needs, and specific print album requirements. Let us know your vision during your consultation.'],
    ...
    $csv_rows[] = [
        ...
        $amritsar_content,
        $amritsar_cta,
        json_encode($service_faqs, JSON_UNESCAPED_UNICODE),
...
file_put_contents( $seeds_dir . '/services-seed.json', json_encode( $json_data, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES ) );

// Write CSV Seed File
$fp = fopen( $seeds_dir . '/services-seed.csv', 'w' );
...
echo "✅ Seeds successfully created under jjw-core/assets/seeds/\n";
